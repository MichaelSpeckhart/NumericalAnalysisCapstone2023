...
std::vector<std::vector<double>> matrix_inverse(std::vector<std::vector<double>> m1);
bool gaussian_elimination(std::vector<std::vector<double>> &A, std::vector<double> &b);
std::tuple<std::vector<std::vector<double>>, std::vector<std::vector<double>>, std::vector<std::vector<double>>> lu_factorization(std::vector<std::vector<double>> &A);
